...
export default function Projects() {
  ...
  return (
    <Punchcard className="relative w-full mx-auto h-auto p-4">
      <FullWidthBanner paragraphText="This section is..." headingText="Under Construction" className="bg-midnight/75 z-50" icons={icons} />
      {/* Outer Container */}
      <div className="z-10">
        <h2 className="text-stroke-header sm:text-3x header-shadow my-4"> {title} </h2>
        {/* Project Circles */}
        <NumberPad /> 
      </div>
